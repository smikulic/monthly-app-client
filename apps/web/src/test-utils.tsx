...
/**
 * Renders under the app's ThemeProvider and a router.
 *
 ...
 * from the token palette. Anything using `useNavigate` or `<Link>` likewise
 * needs a router in context. Tests should import `render` from here rather
 * than from `@testing-library/react`.
 */
