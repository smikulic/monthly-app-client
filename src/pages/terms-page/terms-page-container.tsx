  ...
  return (
    ...
    >
      ...
      <p>
        ...
        investments. The Service is provided free of charge and does not require
      ...
      <p>
        All financial data you enter into the Service (expenses, budgets,
        savings goals, investments) is stored securely and is accessible only to
      ...
      <p>
        ...
        limited license to use, store, and process your User Content solely for
      ...
      <p>
        Monthly is a financial tracking tool only and does not provide financial
        advice. Any financial decisions you make based on information from the
      ...
      <p>
        ...
        action or proceeding relating to your access to, or use of, the Service
      ...
      <p>
        ...
        supersede any prior agreements between you and Monthly relating to the
        Service.
      </p>
    </div>
  );
