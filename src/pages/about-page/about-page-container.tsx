...
export const AboutPageContainer = () => {
  return (
    ...
    >
      ...
      <h2>Hi, I'm a Budgeting Enthusiast!</h2>
      <p>
      ...
      <ul>
        <li>
          <strong>Financial tracking should be simple</strong> – You shouldn't
          need an accounting degree to understand where your money goes
        </li>
        <li>
          <strong>Privacy matters</strong> – Your financial data is yours alone.
          Monthly doesn't require bank connections or sensitive information
        </li>
        <li>
          <strong>Free tools can be powerful</strong> – Everyone deserves access
          to financial planning tools, regardless of their budget
        </li>
        <li>
          <strong>Small steps lead to big changes</strong> – Just tracking your
          expenses can be the first step toward financial freedom
        </li>
      </ul>

      <h2>What Makes Monthly Different</h2>
